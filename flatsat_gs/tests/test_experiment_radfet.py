...
if __name__ == '__main__':
    ...
    sender.send(PerformRadFETExperiment(correlation_id, delay, samples_count, file_name))
    ...
    while True:
        ...
        if isinstance(recv, comm.BeaconFrame):
            ...
            if (count_beacons > 100) and (beacon['08: Experiments']['0518: Current experiment code'] == 0):
                print("Finishing #3.")
                break
    ...
    logger.log("Starting download file")
